        ...
        <main class="main-content">
            ...
            <header class="content-header">
                <div class="welcome-header-text">
                    <span class="welcome-label" style="font-size: 11px; font-weight: 700; color: var(--color-green); letter-spacing: 1px; text-transform: uppercase; display: block; margin-bottom: 2px;">Módulo de Inventario</span>
                    <h1>Stock de Inventario</h1>
                    <p>Administra los niveles de stock físico disponibles en el local.</p>
                </div>
